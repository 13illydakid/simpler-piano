...
export default function Table<T extends Row>({
  ...
  return (
    <>
      <div className="grid bg-gradient-to-r from-black to-white" style={{ gridTemplateColumns }}>
        <TableHead
          columns={columns}
          sortCol={sortCol}
            ...
            return (
              ...
              >
                {columns.map((col, j) => {
                  ...
                  return (
                    <span
                      className="relative px-3 text-sm flex items-center flex-shrink-0 group-hover:bg-green-400 group-even:bg-gray-100"
                      key={`row-${i}-col-${j}`}
