    ...
    <>
      ...
      <div className="bg-white w-full h-screen flex flex-col">
        ...
        <div className="flex h-screen">
          <div className="w-14 bg-gradient-to-b from-black to-white text-white px-4 py-2"></div>
          <div className="p-6 mx-auto max-w-screen-lg flex flex-col flex-grow w-full py-20">
            <h2 className="text-3xl">Song Library</h2>
            <Sizer height={8} />
            <h3 className="text-base"> Please choose a Song</h3>
            <Sizer height={24} />
            ...
            <Table
              columns={[
                ...
                { label: 'Length', id: 'duration', format: (n) => formatTime(Number(n)) },
          ...
          <div className="w-14 bg-gradient-to-b from-white to-black text-white px-4 py-2"></div>
        </div>
